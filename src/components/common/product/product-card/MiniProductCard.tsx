...
export function MiniProductCard({data}: Props) {
    return (
        <Link href={{pathname: "/products/[id]", query: {id: data.id}}} className="flex gap-3 lg:gap-5 border border-transparent hover:border-gray-200 rounded-md shadow-sm shadow-gray-200 md:py-3">
