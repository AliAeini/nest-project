import {IconBox, ImageVeiw, Logo} from "@/components";
        ...
        <footer className="container mb-[68px]">
            <div className="mb-[68px]">
                <div
                    ...
                    <ImageVeiw src="/assets/images/Screenshot (76).png" width={587} height={331} alt="image" className="absolute bottom-0 right-0 sm:h-full h-3/4"/>
                </div>
            </div>
            <div
                ...
                <div className="pt-4 md:pt-0">
                    ...
                    <div className="flex items-center gap-6 justify-center xl:justify-start pt-4 lg:pt-5">
                        <Link href="#"><ImageVeiw src="/assets/images/va724oeh 1.png" alt="Download app from apple store" width={129} height={39}/></Link>
                        <Link href="#"><ImageVeiw src="/assets/images/17kw6njp 1.png" alt="Download app from google play" width={129} height={39}/></Link>
                    </div>
                    ...
                    <div className="flex justify-center xl:justify-start pt-4 lg:pt-5">
                        <ImageVeiw src="/assets/images/payment-method%201.png" alt="payment methods" width={225} height={33}/>
                    </div>
                </div>
            </div>
            {/*// <!--copyright-->*/}
