...
export function Menu() {
    return (
        <>
            <div id="all_categories" className="flex relative cursor-pointer bg-green-200 gap-2.5 text-white px-3 py-2 rounded-[5px] items-center">
                ...
                <div id="all_categories_box" className="hidden absolute z-20 bg-white left-0 top-16 w-[550px] border-[1px] border-light_gray rounded-[5px] p-7 hover:cursor-default">
